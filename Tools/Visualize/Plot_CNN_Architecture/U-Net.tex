...
\begin{tikzpicture}
	...
	% Decoder
	\pic[shift={(1, 0, 0)}] at (cr5-east) {Box={name=up4, caption=Unpool, fill=\UnpoolColor, opacity=0.6, height=2.5, width=1, depth=2.5}};
	...
	\pic[shift={(0, 3, 0)}] at (ucr4-anchor) {Ball={name=cat4, caption=Concat, fill=\ConcatColor, radius=2.5, logo=$||$}};
	...
	\pic[shift={(1, 0, 0)}] at (ucr4a-east) {Box={name=up3, caption=Unpool, fill=\UnpoolColor, opacity=0.6, height=5, width=1, depth=5}};
	...
	\pic[shift={(0, 3, 0)}] at (ucr3-anchor) {Ball={name=cat3, caption=Concat, fill=\ConcatColor, radius=2.5, logo=$||$}};
	...
	\pic[shift={(1, 0, 0)}] at (ucr3a-east) {Box={name=up2, caption=Unpool, fill=\UnpoolColor, opacity=0.6, height=10, width=1, depth=10}};
	...
	\pic[shift={(0, 3, 0)}] at (ucr2-anchor) {Ball={name=cat2, caption=Concat, fill=\ConcatColor, radius=2.5, logo=$||$}};
	...
	\pic[shift={(1, 0, 0)}] at (ucr2a-east) {Box={name=up1, caption=Unpool, fill=\UnpoolColor, opacity=0.6, height=20, width=1, depth=20}};
	...
	\pic[shift={(0, 5, 0)}] at (ucr1-anchor) {Ball={name=cat1, caption=Concat, fill=\ConcatColor, radius=2.5, logo=$||$}};
	...
	\dashedblock{18.6, -16}{22.8, 6}{20.5, 5}{Bottleneck}
	\dashedblock{22.8, -16}{50.7, 6}{33, 5}{Decoder Path}
	\dashedblock{50.7, -16}{53.5, 6}{52, 5}{Output}
