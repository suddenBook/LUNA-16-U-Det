...
\begin{tikzpicture}
	...
	\pic[shift={(2,3,0) }] at (oriinput-east) {RightBandedBox={name=input3d,caption=3D Patch,fill=\ConvColor,height=10,width=2,depth=10}};
	\pic[shift={(0,-6,0) }] at (input3d-east) {RightBandedBox={name=input2d,caption=Multiscale\\2D\\Patch,fill=\ConvColor,height=10,width=2,depth=10}};
