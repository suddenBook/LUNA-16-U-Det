...
def UDet(input_shape=(512, 512, 1)):
    ...
    up6 = concatenate(
        [Conv2DTranspose(512, (2, 2), strides=(2, 2), padding="same")(conv5), outs[3]],
        axis=3,
    )
    ...
    up7 = concatenate(
        [Conv2DTranspose(256, (2, 2), strides=(2, 2), padding="same")(conv6), outs[2]],
        axis=3,
    )
    ...
    up8 = concatenate(
        [Conv2DTranspose(128, (2, 2), strides=(2, 2), padding="same")(conv7), outs[1]],
        axis=3,
    )
    ...
    up9 = concatenate(
        [Conv2DTranspose(64, (2, 2), strides=(2, 2), padding="same")(conv8), outs[0]],
        axis=3,
    )
